...
var App = React.createClass({
  ...
  render: function () {
    ...
    var app = React.createElement('div', {}, React.createElement('h1', {
      'className': 'cover-heading'
    }, 'react-nest-thermostat'), thermostat, React.createElement('div', {
    ...
    }, 'Ambient Temperature'), React.createElement('input', {
      ...
      'value': 'heating'
    }, 'Heating'), React.createElement('option', {
      'value': 'cooling'
    }, 'Cooling')))), React.createElement('div', {
      'className': 'col-md-6'
    }, React.createElement('div', {
      'className': 'form-group'
    }, React.createElement('label', {
      'htmlFor': 'targetTemperature'
    }, 'Target Temperature'), React.createElement('input', {
...
},{"../../src/react-nest-thermostat.js":160,"react":159,"react-dom":3}],2:[function(require,module,exports){
...
var Thermostat = React.createClass({
  ...
  render() {
    ...
    var tickPoints = [[radius - 1, ticksOuterRadius], [radius + 1, ticksOuterRadius], [radius + 1, ticksInnerRadius], [radius - 1, ticksInnerRadius]];
    var tickPointsLarge = [[radius - 1.5, ticksOuterRadius], [radius + 1.5, ticksOuterRadius], [radius + 1.5, ticksInnerRadius + 20], [radius - 1.5, ticksInnerRadius + 20]];
    ...
    }, tickArray), React.createElement('text', {
      'x': radius,
      'y': radius,
